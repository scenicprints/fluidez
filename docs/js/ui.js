...
const EN = {
  ...
  // before you read
  prepLabel: 'Before you read',
  prepGap: '{n} of its {a} words are still new to you',
  prepReady: 'You already know all {a} of its words',
  prepGo: 'Learn the next {n}',
  prepLeft: '{n} to learn',
  prepMeet: 'A new word',
  prepGotIt: 'Got it',
  prepRecognise: 'What does it mean?',
  prepProduce: 'Which word is that?',
  prepGapPrompt: 'The story says',
  prepRight: 'Correct', prepWrong: 'Not that one', prepWas: 'It was **{a}**.',
  prepNext: 'Next',
  prepBatchDone: '{n} learned. {r} still to go.',
  prepKeep: 'Learn the next {n}',
  prepAllDone: 'Every word in this story is yours now.',
  prepStart: 'Start the story',
  prepStartAnyway: 'Start the story anyway',
