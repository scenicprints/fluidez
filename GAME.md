...
the app yet. El Centro is written — 12 missions of 122.**
...
- `content/game/` — the missions themselves. **12 written so far: all of
  El Centro.** El Mercado is next.
...
**1. ~~Write the rest of El Centro~~ — done.** All 12 are written and pushed.
**El Mercado is the immediate job**: twelve missions, `mercado-01` to
`mercado-12`, planned on the spine.

Copy `.github/scripts/game_write_centro_rest.py` in the content repo and edit it.
